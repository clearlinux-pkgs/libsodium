...
Source0  : https://github.com/jedisct1/libsodium/releases/download/1.0.16/libsodium-1.0.16.tar.gz
Summary  : A modern and easy-to-use crypto library
Group    : Development/Tools
License  : ISC
Requires: libsodium-lib
Requires: libsodium-license
...
export LANG=C
export SOURCE_DATE_EPOCH=1533766210
...
export SOURCE_DATE_EPOCH=1533766210
rm -rf %{buildroot}
mkdir -p %{buildroot}/usr/share/doc/libsodium
cp LICENSE %{buildroot}/usr/share/doc/libsodium/LICENSE
%make_install
...
/usr/lib64/libsodium.so.23.1.0

%files license
%defattr(-,root,root,-)
/usr/share/doc/libsodium/LICENSE
